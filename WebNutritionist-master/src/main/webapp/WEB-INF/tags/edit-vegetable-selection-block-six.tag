...
<%@ attribute name="vegetableSelection" required="false" 	type="net.www.webnutritionist.entity.VegetableSelectionSix"%>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-9">
				...
				<div style="padding: 0 30px;">
					<webnutritionist:form-input-slider-vegetable-selection-six index="${index }" value="${vegetableSelection != null ? vegetableSelection.quantity.sliderIntValue : 0}" />
				</div>
			</div>
		</div>
	</div>
