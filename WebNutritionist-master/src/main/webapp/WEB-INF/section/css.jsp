...
<c:choose>
	<c:when test="${production }">
		<link rel="stylesheet" href="/static/css/webnutritionist-common.min.css?v=${cssCommonVersion }">
		...
		<sec:authorize access="isAuthenticated()">
			<link rel="stylesheet" href="/static/css/webnutritionist-ex.min.css?v=${cssExVersion }">
		</sec:authorize>
	</c:when>
	<c:otherwise>
		<link rel="stylesheet" href="/static/css/bootstrap-3.3.6.css">
