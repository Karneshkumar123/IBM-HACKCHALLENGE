...
import net.www.webnutritionist.component.impl.ApplicationListener;
import net.www.webnutritionist.component.impl.DebugFilter;
import net.www.webnutritionist.component.impl.ErrorHandler;

public class WebNutritionistApplicationInitializer implements WebApplicationInitializer {
	...
	private WebApplicationContext createWebApplicationContext(ServletContext container) {
		...
		ctx.scan("net.www.webnutritionist.configuration");
