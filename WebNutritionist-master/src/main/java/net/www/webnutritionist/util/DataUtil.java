...
public class DataUtil {
	...
	public static String convertNameToNumberAndSM(String name) {
		return StringUtils.substringAfterLast(name, "SM_");
	}
	
	public static String convertNameToNumberAnd_(String name) {
		return StringUtils.substringAfterLast(name, "_");
	}
	
	public static String convertAbsolutePath(String name) {
		return StringUtils.remove(name, "D:\\dev-study_lesson\\practic\\webnutritionist\\src\\main\\webapp");
	}
	
	public static String convertCaptchaTextFourSymbol(String name){
	...
	public static <T> int compareByFields(Comparable<T> firstFieldValue, Comparable<T> secondFieldValue,
			boolean nullFirst) {
	...
	private static void copyAccessibleField(Field field, Object from, Object to,
