...
@Entity
@Table(name = "vegetable_selection_six")
public class VegetableSelectionSix extends AbstractEntity<Long> implements Serializable, ProfileEntity {
	private static final long serialVersionUID = 1L;
	
	@Id
	@SequenceGenerator(name="vegetable_selection_six_id_generator", sequenceName="seq_vegetable_selection_six", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="vegetable_selection_six_id_generator")
	private Long id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VegetableSelectionSix other = (VegetableSelectionSix) obj;
		if (id == null) {
			if (other.id != null)
				return false;
